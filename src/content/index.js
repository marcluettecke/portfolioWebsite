	...
	projects: {
		...
		websites: [
			...
			},
			{
				...
				description:
					'Why not build your CV as a website? The entire project is coded in vanilla HTML5 and CSS3 with some minor functions in javascript. The website allows for a direct "print to pdf" button, which saves a pdf of the selected theme as a one-pager.',
